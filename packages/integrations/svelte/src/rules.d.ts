...
export interface RuleOptions {
   ...
   */
  'svelte/no-spaces-around-equal-signs-in-attribute'?: Linter.RuleEntry<SvelteNoSpacesAroundEqualSignsInAttribute>
  /**
...
interface SvelteNoSpacesAroundEqualSignsInAttribute {
  [k: string]: unknown | undefined
}
